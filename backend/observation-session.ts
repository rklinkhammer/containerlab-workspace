...
export function readObservationSession(path:string|undefined){
 ...
 try{
  ...
  return{reanalysisCapability:s.reanalysisCapability==='reanalysis/0.1'?s.reanalysisCapability:undefined,luaCapability:s.luaCapability==='reviewed-lua/0.1'?s.luaCapability:undefined,captureCapability:s.captureCapability==='capture/0.1'?s.captureCapability:undefined,vm:s.vm,expiresAt:s.expiresAt,profile:s.profile,graph,binding,logCapability:s.logCapability==='node-logs/0.1'?s.logCapability:undefined};
