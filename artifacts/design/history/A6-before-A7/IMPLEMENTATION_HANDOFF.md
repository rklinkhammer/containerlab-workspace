...
Updated 2026-09-24: architecture A6 in this workspace, derived from investigation A2 and qualification run 03. See the [current design index](artifacts/design/README.md) and [completion manifest](artifacts/design/COMPLETION.json).
...
containerlab-workspace/
  ...
  artifacts/design/          # Current A6 baseline, decisions, tests and provenance
