# TT-01 — trusted single-user test profile (A9)
...
The application now includes synthetic and recorded-native fixture previews. Native trials are isolated experiments, not a new live ingestion service. The next implementation candidate is bounded live resolution of explicit local fixture bundles, feeding the implemented projection with explicit unsupported/unresolved fields. Broader corpus fidelity and durable real-source handling remain separate work.
