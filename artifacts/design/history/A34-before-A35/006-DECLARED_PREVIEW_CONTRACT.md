...
**A11 extension:** the recorded `p1a/0.3` contract remains unchanged in meaning. [On-demand p1a/0.4](ON_DEMAND_CONTRACT.md) shares object invariants with distinct executed/bundle provenance.
