...
Updated 2026-09-24: architecture A5 in this workspace, derived from investigation A2 and qualification run 03. See the [current design index](artifacts/design/README.md) and [completion manifest](artifacts/design/COMPLETION.json).
