...
The server is running from `/Users/rklinkhammer/workspace/containerlab-releases/0.3.0-preview.7/Containerlab GUI Live.app`, using bundled Node and `/tmp` working directory. `LIVE-003/server.json` records its exact PID/arguments; do not kill another process holding4173. No repository application code is imported at runtime.

After closing this server, the reproducible launch is:

```sh
APP="/Users/rklinkhammer/workspace/containerlab-releases/0.3.0-preview.7/Containerlab GUI Live.app/Contents/Resources"
