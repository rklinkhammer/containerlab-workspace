...
Locator: getByRole('button', { name: 'Link 1 · veth' })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('button', { name: 'Link 1 · veth' }) with timeout 5000ms
  - waiting for getByRole('button', { name: 'Link 1 · veth' })
...
- navigation "Synthetic scenarios":
  ...
  - combobox "Recorded native fixture":
    ...
    - option "Native F1 · partial" [selected]
...
- main:
  - text: P1A / RECORDED NATIVE PREVIEW
  - heading "Native F1" [level=1]
  - paragraph: Parallel links and native aliases
  - text: Read-only topology
  - strong: Fixture data only
  - text: Recorded EXP-013 native resolution. No live resolution or deployment. This view does not establish corpus compatibility.
  - term: Source ID
  - definition: F1
  - term: Source SHA-256
  - definition: c66a474ca9a9a4cba7de16c29dcc995219854418dc48e1b0ef13841c5aa50911
  - term: Resolver commit
  - definition: 5ae50094a3afd70e4e1674fe5385e64d8979da26
  - term: Evidence
  - definition: EXP-013 · recorded, not live
  - button "Live inspection" [disabled]
  - button "Terminal" [disabled]
  - button "Capture" [disabled]
  - button "Packet analysis" [disabled]
  - region "Topology and object list":
    - strong: "4"
    - text: nodes
    - strong: "3"
    - text: link occurrences partial
    - application:
      - img:
        - img "Edge from 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:1 to 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:2": 1 · node
      - img:
        - img "Edge from 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:1 to 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:2": 2 · node
      - img:
        - img "Edge from 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:3 to 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:n:1": 3 · node
      - button "Inspect isolated": isolated linux
      - button "Inspect left": left linux
      - text: eth1 eth2 eth3
      - button "Inspect right": right linux
      - text: eth1 eth2
      - button "Inspect srl": srl nokia_srlinux
      - text: e1-1
      - img
      - button "Zoom In":
        - img
      ...
      - link "React Flow attribution":
        ...
        - text: React Flow
    - text: ● Native node ◇ External endpoint — Link occurrence, not traffic direction
    - region "Accessible object list":
      - heading "Objects Keyboard-accessible selection" [level=2]
      - heading "Nodes" [level=3]
      - button "isolated linux"
      - button "left linux"
      - button "right linux"
      - button "srl nokia_srlinux"
      - heading "Link occurrences" [level=3]
      - button "Link 1 · node 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:l:0"
      - button "Link 2 · node 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:l:1"
      - button "Link 3 · node 9b262216a7587f9f9714f3d6f9381f12956c77e038ad9c4425b71f431eae37c5:l:2"
    - region "Diagnostics":
      - heading "Resolution notes" [level=2]
      - paragraph: info Recorded native resolution from EXP-013. No live lab connection.
      - paragraph: warning Source tokens and field coordinates are unresolved. Native values are not source declarations.
  - complementary "Object inspector":
    - text: INSPECTOR
    - heading "Select an object" [level=2]
    - paragraph: Choose a node on the canvas or an entry in the object list. Every link occurrence stays distinct.
    - text: Recorded native values. Original tokens and field origins remain unresolved. No live observations.
  - text: Containerlab remains the topology authority. Contract p1a/0.2 · Recorded native evidence
```
