...
func main(){
 ...
 c,err:=core.NewContainerLab(core.WithRuntime("docker",&rt.RuntimeConfig{Timeout:5*time.Second}),core.WithTopoPath(os.Args[1],nil));if err!=nil{out["stage"]="load";out["native_error"]=err.Error();return}
 if err=c.ResolveLinks();err!=nil{out["stage"]="links";out["native_error"]=err.Error();return}
