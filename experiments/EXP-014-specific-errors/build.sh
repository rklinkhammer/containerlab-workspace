...
set -eu
umask 077
mkdir -p /tmp/exp014/source /tmp/exp014/bin
cd /tmp/exp014
...
mkdir -p source/exp014
cp main.go source/exp014/main.go
cd source
export PATH=/tmp/exp014/go/bin:$PATH
export GOTOOLCHAIN=local
go version
timeout -k 5 900 go build -mod=readonly -o /tmp/exp014/bin/probe ./exp014
sha256sum /tmp/exp014/bin/*
