...
set -eu
umask 077
mkdir -p /tmp/exp016/source /tmp/exp016/bin
cd /tmp/exp016
...
mkdir -p source/exp016
cp main.go source/exp016/main.go
cd source
export PATH=/tmp/exp016/go/bin:$PATH
export GOTOOLCHAIN=local
go version
timeout -k 5 900 go build -mod=readonly -o /tmp/exp016/bin/probe ./exp016
sha256sum /tmp/exp016/bin/*
